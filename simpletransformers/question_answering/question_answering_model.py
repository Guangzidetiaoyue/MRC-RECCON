...
from .my_model import RobertaForQuestionAnswering
    ...
    def bert_batch_preprocessing(self,batch):
        if len(batch[0])==16:
            all_input_ids,all_attention_masks,all_token_type_ids,all_start_positions,\
                ...
                all_token_idx,all_segment_idx,all_clause_idx,all_conv_len,all_utterance_input,all_q_query_input,all_q_query_mask,all_q_query_token_type = zip(*batch)
            ...
            return all_input_ids,all_attention_masks,all_token_type_ids,all_start_positions,\
                all_end_positions,all_cls_index,all_p_mask,all_is_impossible,\
                all_token_idx,all_segment_idx,all_clause_idx,all_conv_len,adj_b,all_utterance_input,all_q_query_input,all_q_query_mask,all_q_query_token_type
        else:
            all_input_ids,all_attention_masks,all_token_type_ids,all_feature_index,all_cls_index,all_p_mask,all_is_impossible,all_token_idx,all_segment_idx,all_clause_idx,all_conv_len,all_utterance_input,all_q_query_input,all_q_query_mask,all_q_query_token_type = zip(*batch) #all_start_positions,\all_end_positions,
            N = max(all_conv_len).cpu().numpy().tolist()
            adj_b = []
            for doc_len in all_conv_len:
                doc_len = doc_len.cpu().numpy().tolist()
            ...
            return all_input_ids,all_attention_masks,all_token_type_ids,all_feature_index,all_cls_index,all_p_mask,all_is_impossible,all_token_idx,all_segment_idx,all_clause_idx,all_conv_len,adj_b,all_utterance_input,all_q_query_input,all_q_query_mask,all_q_query_token_type #all_start_positions,\all_end_positions,

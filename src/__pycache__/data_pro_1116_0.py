...
data_train_res_0 = 'data/my_data_pro/subtask1/fold1/dailydialog_qa_train_with_context_new_0_c.json'
data_valid_res_0 = 'data/my_data_pro/subtask1/fold1/dailydialog_qa_valid_with_context_new_0_c.json'
data_test_dd_res_0 = 'data/my_data_pro/subtask1/fold1/dailydialog_qa_test_with_context_new_0_c.json'
data_test_ie_res_0 = 'data/my_data_pro/subtask1/fold1/iemocap_qa_test_with_context_new_0_c.json'
...
with open(data_test_ie_sub1, 'r') as f1: #data_train_sub1,data_valid_sub1,data_test_dd_sub1,data_test_ie_sub1
    ...
    for r in data_sub1:
        ...
        if not is_impossible:
            ...
            q_n = 'Is the source utterance the evidence utterance'
            q_s = 'The evidence utterance is'
            q_s_n = 'The source utterance is'
            ...
            query_new_0 = sub1_qa[0]['question'][:query_idx_e]+ q_n +sub1_qa[0]['question'][query_idx_e_l:]
            query_new_0_c = query_new_0.replace(q_s,q_s_n)
            sub1_qa[0]['question'] = query_new_0_c #question_new_0
            ...
            if start_position_character > 450:
                ...
                for i in range(1,len(context_new)):
                    ...
                    if answer_start_new != -1 and evidence_a_s > 0 and answer_start_new > 0:
                        if len(context6_temp_7) > 512 and len(context6_temp) < 512:
                            ...
                            sub1_qa[0]['answers'] = [{'text':evidence_u,'answer_start_new':evidence_a_s,'answer_start':answer_start_new,'answer_cls':1}] #answers_new_0
                ...
                sub1_qa[0]['answers'] = [{'text':evidence_u,'answer_start':start_position_character,'answer_start_new':start_evidence_u,'answer_cls':1}]
            ...
            sub1_qa[0]['answers'] = [{'text':answer_text,'answer_start':start_position_character,'answer_start_new':start_position_character,'answer_cls':0}] #answers_new_0
...
# with open(data_train_ori, 'r') as f: #data_train_ori,data_valid_ori,data_test_dd_ori,data_test_ie_ori
#     data = json.load(f)
#     # for row in data:
#     #     print(row)
#     #     c_data = data[row]
...
# with open(data_train_sub1, 'r') as f1: #data_train_sub1,data_valid_sub1,data_test_dd_sub1,data_test_ie_sub1
#     data_sub1 = json.load(f1)
...
#     with open(data_train_res_0,'w',encoding='utf-8') as f2: #data_train_res,data_valid_res,data_test_dd_res,data_test_ie_res
#         f2.write(json.dumps(data_sub1, ensure_ascii=True, indent=4, separators=(',', ':')))
    ...
    for r in data_sub1:
        ...
        if not is_impossible:
            ...
            if start_position_character > 450:
                ...
                for i in range(1,len(context_new)):
                    ...
                    if answer_start_new != -1 and evidence_a_s > 0 and answer_start_new > 0:
                        if len(context6_temp_7) > 512 and len(context6_temp) < 512:
                            ...
                            sub1_qa[0]['answers'] = [{'text':answer_text,'answer_start_new':answer_start_new,'answer_start':answer_start_new}] #answers_new_0
                ...
                sub1_qa[0]['answers'] = [{'text':answer_text,'answer_start':start_position_character,'answer_start_new':start_position_character}]
...
# with open(data_valid_ori, 'r') as f: #data_train_ori,data_valid_ori,data_test_dd_ori,data_test_ie_ori
#     data = json.load(f)
#     # for row in data:
#     #     print(row)
#     #     c_data = data[row]
...
# with open(data_valid_sub1, 'r') as f1: #data_train_sub1,data_valid_sub1,data_test_dd_sub1,data_test_ie_sub1
#     data_sub1 = json.load(f1)
...
#     with open(data_valid_res_1,'w',encoding='utf-8') as f2: #data_train_res,data_valid_res,data_test_dd_res,data_test_ie_res
#         f2.write(json.dumps(data_sub1, ensure_ascii=True, indent=4, separators=(',', ':')))
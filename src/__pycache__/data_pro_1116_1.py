...
data_train_res_1 = 'data/my_data_pro/subtask1/fold1/dailydialog_qa_train_with_context_new_1_c.json'
data_valid_res_1 = 'data/my_data_pro/subtask1/fold1/dailydialog_qa_valid_with_context_new_1_c.json'
data_test_dd_res_1 = 'data/my_data_pro/subtask1/fold1/dailydialog_qa_test_with_context_new_1_c.json'
data_test_ie_res_1 = 'data/my_data_pro/subtask1/fold1/iemocap_qa_test_with_context_new_1_c.json'
...
#                             sub1_qa[0]['answers'] = [{'text':answer_text,'answer_start_new':answer_start_new,'answer_start':answer_start_new,'answer_cls':0}] #answers_new_0
...
#                 sub1_qa[0]['answers'] = [{'text':answer_text,'answer_start':start_position_character,'answer_start_new':start_position_character,'answer_cls':0}]
...
#     with open(data_test_ie_res_1,'w',encoding='utf-8') as f2: #data_train_res,data_valid_res,data_test_dd_res,data_test_ie_res
...
with open(data_train_sub1, 'r') as f1: #data_train_sub1,data_valid_sub1,data_test_dd_sub1,data_test_ie_sub1
    ...
    for r in data_sub1:
        ...
        if not is_impossible:
            ...
            # start_query_new_0 = context.find(evidence_u)
            q_1_n = 'The evidence utterance is '+ evidence_u + ' What is the causal span from context that is relevant to the evidence utterance ?'
            sub1_qa[0]['question'] = q_1_n #question_new_0
            sub1_qa[0]['answers'] = [{'text':answer_text,'answer_start':start_position_character,'answer_start_new':start_position_character,'answer_cls':0}] #answers_new_0
    ...
    with open(data_train_res_1,'w',encoding='utf-8') as f2: #data_train_res,data_valid_res,data_test_dd_res,data_test_ie_res
        f2.write(json.dumps(data_sub1, ensure_ascii=True, indent=4, separators=(',', ':')))
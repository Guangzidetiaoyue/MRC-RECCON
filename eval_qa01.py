...
def evaluate_results(text):
    ...
    # if (impos2+impos3)==0 or (impos3+impos4) or impos2==0: #attention
...
if __name__ == '__main__':
    ...
    parser.add_argument('--context', action='store_true', default=True, help='use context')
    parser.add_argument('--dataset', default='iemocap', help='which dataset dailydialog | iemocap')
    ...
    if context == False:
        save_dir    = 'outputs01/' + model_id[model] + '-dailydialog-qa-without-context-fold' + fold + '/'
        ...
        x_test_0  = json.load(open('data/my_data_pro/subtask1/fold' + fold + '/' + dataset +'_qa_test_with_context_new_0_c.json'))
        x_test_1  = json.load(open('data/my_data_pro/subtask1/fold' + fold + '/' + dataset +'_qa_test_with_context_new_1_c.json'))
    ...
    # print (r_0)
    rf = open('results01/evaluation_' + dataset + '_qa_0.txt', 'a')
    rf.write(str(args) + '\n\n')
    # rf.write(r_0 + '\n' + '-'*40 + '\n')    
    rf.close()
    ...
    print (r_1)
    rf = open('results01/evaluation_' + dataset + '_qa_1.txt', 'a')
    rf.write(str(args) + '\n\n')
    rf.write(r_1 + '\n' + '-'*40 + '\n')    
    rf.close()
